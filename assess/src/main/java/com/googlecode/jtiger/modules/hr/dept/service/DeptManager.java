...
public class DeptManager extends BaseGenericsManager<Dept> {
	 ...
	 * @return
	 */
	public Map<String, Object> getDeptTree(Map<String, Object> parent,
			boolean nested, Integer deptId) {
		// 得到子部门
	...
	public Dept getDeptByCode(String deptCode) {
		String hql = "from Dept d where d.deptCode = ?";
		List<Dept> list = query(hql, deptCode);
